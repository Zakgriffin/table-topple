...
//
// The second is the purity alarm. This imports src/poseViewer/shared/fixture.ts
...
import { decodeGray, fixtureSummary, validateFixture } from '../src/poseViewer/shared/fixture.ts';
