...
import { type Camera, type CameraPose, type CompositeLine, type PendingVisuals } from '../../shared/camera/model.ts';
import { activeCamera, isPhysical, isSimulated } from '../camera/store.ts';
import { COL_DIR, GRID_STEP, ROW_DIR, SPHERE_RADIUS } from '../../shared/constants.ts';
...
// (LSD tuning, the join knobs, minGrazingCos, forceCPU). Guarded by the same axesCapturing
