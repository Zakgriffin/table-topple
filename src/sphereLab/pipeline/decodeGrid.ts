...
import { type DecodeCellDebug, type DecodeSampleGrid, type DecodeSamplePoint, type PositionDecodeResult, type RecoveredAxes, type VoteResult } from '../types.ts';
...
// pipeline/intermediates.ts). It used to park itself on the camera, which meant
