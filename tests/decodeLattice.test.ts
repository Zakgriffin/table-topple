...
import { buildDecodeLattice } from '../src/poseViewer/server/pipeline/decodeLattice.ts';
...
const SETTINGS = {
  ...
  // nothing checks.
  join: { vFovRad: vFovRadOf(FRAME_DIMS), endpointNoisePx: 0.5, kSigma: 3, reachFrac: 4, rounds: 3, maxResidualPx: 2, polarityAbs: false },
